...
public abstract class PlayerMixin extends LivingEntity {
	...
	@WrapOperation(
			method = {
					...
					"isWithinEntityInteractionRange(Lnet/minecraft/world/phys/AABB;D)Z"
			},
			at = @At(
					value = "INVOKE",
	...
	private double interactThroughPortals(AABB box, Vec3 pos, Operation<Double> original,
										  @Local(name = "maxRange") double range) {
	...
	// TODO: Jay, stop playing terraria - Max
...
//			return source;
//
//		Optional<PortalPath> path = PortalAwareAttackPacket.currentPath();
//		if (path.isEmpty())
//			return source;
//
