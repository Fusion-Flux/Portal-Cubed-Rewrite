												...
												(face, facing, offset, base, active) -> {
													...
													variant = switch (faceAxis) {
														...
														case Y -> switch (facing) {
															case SOUTH ->
																	flip ? variant.with(VariantProperties.X_ROT, VariantProperties.Rotation.R180)
														...
														case Z -> switch (facing) {
															case SOUTH ->
																	flip ? variant.with(VariantProperties.X_ROT, VariantProperties.Rotation.R90)
																			.with(Z_ROT, 180)
													...
													Vec3 shift = offset.get(face, facing, base);
													if (shift.x() != 0)
