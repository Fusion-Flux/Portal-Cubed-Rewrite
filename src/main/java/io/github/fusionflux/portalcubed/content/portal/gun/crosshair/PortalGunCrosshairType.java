...
public record PortalGunCrosshairType(
	...
	public static final Codec<PortalGunCrosshairType> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Identifier.CODEC.optionalFieldOf("base").forGetter(PortalGunCrosshairType::base),
	...
	public record Indicator(Identifier empty, Identifier placed, Optional<Identifier> lastPlaced) {
		public static final Codec<Indicator> CODEC = RecordCodecBuilder.create(instance -> instance.group(
				Identifier.CODEC.fieldOf("empty").forGetter(Indicator::empty),
				Identifier.CODEC.fieldOf("placed").forGetter(Indicator::placed),
				Identifier.CODEC.optionalFieldOf("last_placed").forGetter(Indicator::lastPlaced)
