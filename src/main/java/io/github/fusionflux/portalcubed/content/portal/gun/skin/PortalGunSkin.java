...
public record PortalGunSkin(Component name, Identifier itemModel, Optional<Integer> inactiveColor, Sounds sounds) {
	public static final Codec<PortalGunSkin> CODEC = RecordCodecBuilder.create(instance -> instance.group(
			...
			Identifier.CODEC.fieldOf("item_model").forGetter(PortalGunSkin::itemModel),
