...
public class FizzleDarkParticle extends FadingParticle {
	...
	protected FizzleDarkParticle(ClientLevel world, double x, double y, double z, TextureAtlasSprite sprite) {
	...
	public record Provider(FabricSpriteSet spriteSet) implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType options, ClientLevel level, double x, double y, double z, double xAux, double yAux, double zAux, RandomSource random) {
			FizzleDarkParticle particle = new FizzleDarkParticle(level, x, y, z, this.spriteSet.get(random));
