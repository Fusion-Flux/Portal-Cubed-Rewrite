...
public enum PanelPart {
	...
	CHECKERED_FACADE("checkered_panel_facade", SimpleMultifaceBlock::new),
	HALF("half_panel"),
	HALF_SLAB("half_panel_slab", SlabBlock::new),
	HALF_STAIRS("half_panel_stairs", SaneStairBlock::new),
	HALF_FACADE("half_panel_facade", SimpleMultifaceBlock::new),
	SINGLE("panel"),
	SLAB("panel_slab", SlabBlock::new),
	STAIRS("panel_stairs", SaneStairBlock::new),
	FACADE("panel_facade", SimpleMultifaceBlock::new),
