...
public record Signage(Optional<Identifier> cleanTexture, Optional<Identifier> agedTexture, Component name) {
	public static final Codec<Signage> DIRECT_CODEC = PortalCubedCodecs.validate(
			RecordCodecBuilder.create(instance -> instance.group(
					Identifier.CODEC.optionalFieldOf("clean_texture").forGetter(Signage::cleanTexture),
					Identifier.CODEC.optionalFieldOf("aged_texture").forGetter(Signage::agedTexture),
